...
int main(int argc, char* argv[]) {
    ...
    omp_set_num_threads(16); //Acá se están usando 16 hilos
...
void aplicarFiltro(int *imagen, int *imagenProcesada, int width, int height) {
    ...
    // Paralelización del bucle externo con OpenMP
...
int calcularSumaPixeles(int *imagen, int width, int height) {
    ...
    // Paralelización del bucle con OpenMP y uso de reducción para la suma
